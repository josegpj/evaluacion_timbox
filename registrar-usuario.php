...
include_once("includes/verificar_sesion.php");
  ...
  if(isset($_POST['registrar_usuario'])){
    ...
    $QueryInsertar=$Insertar->RegistrarUsuario($id_usuario, $nombre, $rfc, $telefono, $website, $direccion);
  }
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Timbox | Registrar usuario</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="" action="registrar-usuario.php"  method="post">
                                          <div class="row">
                                              ...
                                              <div class="col-sm-12 col-md-6 col-lg-6">
                                                <b>RFC</b><br>
                                                <input type="text" class="form-control" id="rfc" name="rfc" value="" autocomplete="off" required>
                                              </div>

                                              <div class="col-sm-12 col-md-6 col-lg-6">
                                                <b>Telefono</b><br>
                                                <input type="text" class="form-control" id="telefono" name="telefono" value="" autocomplete="off" required>
                                              </div>

                                              <div class="col-sm-12 col-md-6 col-lg-6">
                                                <b>Website</b><br>
                                                <input type="text" class="form-control" id="website" name="website" value="" autocomplete="off" required>
                                              </div>
